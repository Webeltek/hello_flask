    ...
    <div
      ...
      >
        ...
        >
          ...
          >
            <mwl-calendar-week-view-current-time-marker-mob
            ...
            <div class="cal-events-container">
              <div
                *ngFor="
                ...
                [style.left.px]="timeEvent.top"
                [style.width.px]="timeEvent.height"
                [style.top.%]="timeEvent.left"
                [style.height.%]="timeEvent.width"
                mwlResizable
                [resizeSnapGrid]="{
                  left: dayColumnWidth,
  ...
  implements OnChanges, OnInit, OnDestroy, AfterViewInit
{
  ...
  @Output() eventDroppedHeader = new EventEmitter<{
    event: CalendarEvent;
    newStart: Date;
  }>();

  @Output() dragEnterHeader = new EventEmitter<{ date: Date }>();
  /**
